[![Build Status](https://travis-ci.com/IBM/MAX-Question-Answer.svg?branch=master)](https://travis-ci.com/IBM/MAX-Question-Answer) [![Website Status](https://img.shields.io/website/http/max-question-answer.max.us-south.containers.appdomain.cloud/swagger.json.svg?label=api+demo)](http://max-question-answer.max.us-south.containers.appdomain.cloud/)
